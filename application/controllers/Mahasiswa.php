...
class Mahasiswa extends CI_Controller
{
    ...
    public function input()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->session->set_flashdata('inputSuccess', 'Data Berhasil Ditambahkan');
            redirect('mahasiswa');
        }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->session->set_flashdata('editSuccess', 'Data  Berhasil Diubah');
            redirect('mahasiswa');
        }
    ...
    public function delete($id)
    {
        ...
        $this->session->set_flashdata('deleteSuccess', 'Data Berhasil Dihapus');
